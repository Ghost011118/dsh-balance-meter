window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:C:\Users\Lenovo\Documents\Codex\2026-08-20\ban\work\dsh-balance-meter\src\client\balance.module.css.mjs
		const css = ".gTZn4a_chip{border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface,transparent);height:22px;color:var(--dsh-color-text,inherit);cursor:pointer;white-space:nowrap;border-radius:999px;align-items:center;gap:6px;padding:0 8px;font-size:12px;line-height:1;display:inline-flex;position:relative}.gTZn4a_chip:hover,.gTZn4a_chipOpen{border-color:var(--dsh-color-accent,#50a0ffb3)}.gTZn4a_dot{background:var(--dsh-color-danger,#e5534b);border-radius:50%;flex:none;width:7px;height:7px}.gTZn4a_dotOk{background:var(--dsh-color-success,#2da44e);border-radius:50%;flex:none;width:7px;height:7px}.gTZn4a_details{z-index:40;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface-elevated,#1f1f1f);min-width:140px;color:var(--dsh-color-text,inherit);border-radius:6px;flex-direction:column;gap:2px;padding:6px 8px;font-size:11px;display:flex;position:absolute;top:calc(100% + 6px);left:0;box-shadow:0 4px 12px #0000004d}.gTZn4a_row{justify-content:space-between;align-items:center;gap:12px;display:flex}.gTZn4a_rowRight{align-items:center;gap:4px;display:inline-flex}.gTZn4a_sep{opacity:.45}.gTZn4a_cost{opacity:.85}.gTZn4a_source{background:var(--dsh-color-surface-elevated,#80808029);opacity:.85;border-radius:4px;padding:1px 4px;font-size:10px}.gTZn4a_costRow{border-top:1px solid var(--dsh-color-border,#80808040);justify-content:space-between;align-items:center;gap:12px;margin-top:4px;padding-top:4px;display:flex}";
		...
		var balance_module_css_default = {
			"chip": "gTZn4a_chip",
			"chipOpen": "gTZn4a_chipOpen",
			"cost": "gTZn4a_cost",
			"costRow": "gTZn4a_costRow",
			"details": "gTZn4a_details",
			"dot": "gTZn4a_dot",
			"dotOk": "gTZn4a_dotOk",
			"row": "gTZn4a_row",
			"rowRight": "gTZn4a_rowRight",
			"sep": "gTZn4a_sep",
			"source": "gTZn4a_source"
		};
		//#endregion
		...
		*/
		...
		const balanceApi = {
			view: (sessionId) => balanceFetch(sessionId === void 0 ? "/api/balance" : `/api/balance?session=${encodeURIComponent(sessionId)}`),
			refresh: (sessionId) => balanceFetch(sessionId === void 0 ? "/api/balance/refresh" : `/api/balance/refresh?session=${encodeURIComponent(sessionId)}`),
		...
		*/
		function BalanceDockEntry(props) {
			...
			const sourceLabel = view?.source === "proxy" ? props.t("balance.sourceProxy") : view?.source === "manual" ? props.t("balance.sourceManual") : props.t("balance.sourceOfficial");
			if (view === null || view.error !== void 0) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: balance_module_css_default.source,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					open && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						role: "tooltip",
						children: [
							view.balances.map((b) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							view.source === "manual" && view.initialBalance !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: balance_module_css_default.row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: props.t("balance.manualInitial") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									className: balance_module_css_default.rowRight,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: formatAmount(view.initialBalance) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: view.currency ?? "" })]
								})]
							}),
							view.source === "manual" && view.localSpent !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: balance_module_css_default.row,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: props.t("balance.localSpent") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									className: balance_module_css_default.rowRight,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: formatAmount(view.localSpent) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: view.currency ?? "" })]
								})]
							}),
							cost?.ok === true && cost.cost !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
