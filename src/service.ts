...
export class BalanceService extends Service {
  ...
  private costConfig: ReturnType<typeof resolveCostConfig>
  ...
  private resolveCostFromPreset(config: BalanceConfig): ReturnType<typeof resolveCostConfig> {
   ...
   */
  private effectiveCostConfig(): ReturnType<typeof resolveCostConfig> {
